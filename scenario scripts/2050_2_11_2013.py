...
scenario_string['2050_2_11'] = "industry_fuel,transport,heat,config_overrides,res_1h,gas_storage,"\
...
path_to_netcdf_of_model_inputs = '{}/national/inputs_2050_2_11.nc'.format(opt_horizon)
