...
scenario_string['2050_5_1'] = "industry_fuel,transport,heat,config_overrides,res_1h,gas_storage,"\
                        "link_cap_dynamic,freeze-hydro-capacities,add-biofuel,synfuel_transmission,"\
                        "north_sea,scenario_2050_5_1,floatwind_cap_max,offshorewind_cap_max,onshorewind_cap_min"

selected_scenario = '2050_5_1' 
# Generate and save model inputs
path_to_netcdf_of_model_inputs = '{}/national/inputs_2050_5_1.nc'.format(opt_horizon)
