...
opt_horizon = 2050
path_to_model_yaml = '{}/model/national/model-2013.yaml'.format(opt_horizon)

# Define scenarios
scenario_string = {}

scenario_string['2050_6_10'] = "industry_fuel,transport,heat,config_overrides,res_1h,gas_storage,"\
                        "link_cap_dynamic,freeze-hydro-capacities,add-biofuel,synfuel_transmission,"\
                        "north_sea,scenario_2050_6_10,floatwind_cap_max,offshorewind_cap_max,onshorewind_cap_min"

selected_scenario = '2050_6_10' 
# Generate and save model inputs
path_to_netcdf_of_model_inputs = '{}/national/inputs_2050_6_10_2013.nc'.format(opt_horizon)
...
path_to_netcdf_of_results = 'results/north-sea_{}_2013.nc'.format(selected_scenario)
