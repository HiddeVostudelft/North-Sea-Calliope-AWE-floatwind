...
path_to_netcdf_of_model_inputs = '{}/national/inputs_2050_6_10_2014.nc'.format(opt_horizon)
...
path_to_netcdf_of_results = 'results/north-sea_{}_2014.nc'.format(selected_scenario)
